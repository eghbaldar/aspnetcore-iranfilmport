    ...
    public class TodoListHelper
    {
        ...
        private string Urgent()
        {
            return "\n\n Regular Todo List:\n\n" +
                ...
                "----- 1) از اوتحایی که بین کلاینت و کاربر عادی فرق هست مشتری ها میتونن با همون آیدی که ما براشون میسازیم توی کلاینت هم باشند \r\n" +
                "----- 2) مسیر درست سایتمپ چک شود - بهتر است که سایتمپ قبلی حفظ و از این به بعد سایتمپ جدید لحاظ شود\r\n" +
                "----- 3) \r\n"+
                "----- 4) \r\n"+
                "----- 5) \r\n";
        }
