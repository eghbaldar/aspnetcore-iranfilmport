...
using IranFilmPort.Application.Services.AdvertisementModals.FacadePattern;
...
using IranFilmPort.Application.Services.JobRequests.FacadePattern;
...
using IranFilmPort.Application.Services.Pages.FacadePattern;
...
builder.Services.AddScoped<IJobRequestsFacadePattern, JobRequestsFacadePattern>();
builder.Services.AddScoped<IAdvertisementModalsFacadePattern, AdvertisementModalsFacadePattern>();
builder.Services.AddScoped<IPagesFacadePattern, PagesFacadePattern>();
