...
{
    // what is the difference between this class with "KingAuthorizeAttribute.cs"?
    // in this class, the "LOG Insertion" doesn't happen."
    [AttributeUsage(AttributeTargets.Method | AttributeTargets.Class)]
    public class KingAuthorizeUploadAttribute : Attribute, Microsoft.AspNetCore.Mvc.Filters.IAuthorizationFilter
    {
        private readonly UserRole[] _roles;
        public KingAuthorizeUploadAttribute(params UserRole[] roles)
        {
            _roles = roles;
        }
